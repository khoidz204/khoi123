...
<body>
<h1 class="mt-5 mb-4">Danh sách kích thước</h1>
<div class="row mb-3">
    <div class="col">
    ...
    <div class="col-8">
        <form action="/kich-thuoc/index" class="row g-3">
            <div class="col">
...
<div class="container">
    <table class="table table-hover" border="1">
        ...
        <tbody>
        <c:forEach items="${dataKT.content}" var="kt" varStatus="k">
            <tr>
                <td>${k.index + 1}</td>
                <td>${kt.id}</td>
                <td>${kt.maKT}</td>
                ...
                <td>
                    <a href="/kich-thuoc/edit/${kt.id}" class="btn btn-warning">Update</a>
                </td>
                <td>
                    <a href="/kich-thuoc/delete/${kt.id}" class="btn btn-danger">Delete</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
