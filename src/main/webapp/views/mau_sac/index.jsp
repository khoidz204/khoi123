...
<body>
<h1 class="mt-5 mb-4">Danh sách màu sắc</h1>
<div class="row mb-3">
    <div class="col">
    ...
    <div class="col-8">
        <form action="/mau-sac/index" class="row g-3">
            <div class="col">
...
<div class="container">
    <table class="table table-hover" border="1">
        ...
        <tbody>
        <c:forEach items="${dataMS.content}" var="ms" varStatus="m">
            <tr>
                <td>${m.index + 1}</td>
                <td>${ms.id}</td>
                <td>${ms.maMS}</td>
                <td>${ms.ten}</td>
                <td>${ms.trangThai == 1 ? "Ngừng hoạt động" : "Đang hoạt động"}</td>
                <td>
